...
<html lang="">
	<head>
		...
		<link rel="shortcut icon" href="/lost_found/Public/res/favicon.icon" type="image/x-icon"/>
		<style>
			#main-nav {
	            margin-left: 1px;
	        }
	        ...
	        <div class="row">
	            <div class="col-md-2">
	                <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
	                    ...
	                    <li class="nav-list " >
	                        <a href="javascript:void(0)" onclick="router.action('./pendingOrder')">
	                    ...
	                    <li class="nav-list" ">
	                        <a href="javascript:void(0);" onclick="router.action('./onlineOrder')">
	                    ...
	                    <li class="nav-list" ">
	                        <a href="javascript:void(0);" onclick="router.action('./allOrder')">
	            ...
	            <div class="col-md-10" >
	                <iframe id="mainPage" src="/lost_found" frameBorder="0" width="100%" scrolling="yes" height="900"></iframe>
	            </div>
	        </div>
	    </div>
