...
<html lang="">
	...
	<body>
		...
		<ul class="list-group">
		  <?php if(is_array($list)): foreach($list as $key=>$l): ?><a  href="<?php echo U('Admin/Admin/onlineOrderDetail',array('lost_id'=>$l['lost_id']));?>" style="text-decoration:none;">
				  <li class="list-group-item listItems">
					  ...
					  <div class="col-xs-5 col-sm-5 col-md-5" align="right">
					  	    <a class="btn btn-primary" href="<?php echo U('Admin/Admin/onlineOrderDetail',array('lost_id'=>$l['lost_id']));?>" style="text-decoration:none;">详情
							</a>
					  </div>
					</div>
				  </li>
